...
SIP1_OUTBOUND_PROXY = os.environ.get('SIP1_OUTBOUND_PROXY', '')
...
SIP2_OUTBOUND_PROXY = os.environ.get('SIP2_OUTBOUND_PROXY', '')
...
SIP3_OUTBOUND_PROXY = os.environ.get('SIP3_OUTBOUND_PROXY', '')
